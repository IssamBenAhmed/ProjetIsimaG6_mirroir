...
/*
    ...
    - Les fonds se d�placent lentement sur l'axe x avec des vitesses diff�rentes.
...
int main(void)
{
    ...
    SDL_RendererFlip flip_chien = SDL_FLIP_NONE; // Sert � retourner le chien � gauche.
    ...
    */
    while (continuer)
    {
        ...
        */
        SDL_RenderCopyEx(renderer, chien, &source_chien, &chien_rect, 0, NULL, flip_chien);
