...
int main(void)
{
    ...
    SDL_Renderer *renderer = NULL;   // Outil qui permet de dessiner dans la fenêtre.
    ...
    */
    while (continuer)
    {
        ...
        */
        ...
        SDL_RenderDrawLine(renderer,homme_x - 20, homme_y - 60,homme_x - 55, homme_y - 25);
        ...
        */
        ...
        SDL_RenderDrawLine(renderer,homme_x - 10, homme_y - 5, homme_x - 35, homme_y + 70);
        ...
        */
        SDL_RenderDrawLine(renderer,homme_x - 35, homme_y + 70, homme_x - 60, homme_y + 70);
